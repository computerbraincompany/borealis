...
| v21+ | v21 = MCP accepted-run binding snapshot (stage 4 executing, re-keyed from an erroneous v25 back to v21 with no placeholder queue); later slots allocated at dispatch only | No placeholders or jumps; coordinator revalidates contiguity at every merge |
