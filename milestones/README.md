...
**Ledger reviewed:** 2026-08-31 against commit `f1b9293`.
...
- Horizon 0 (honor what already works) has no milestone: it is the continuous
  ...
  keep passing. Plans 001–030 established the historical baseline; M01–M11
  extended it without replacing that obligation.
- M07 delivered the first Horizon 3 substrate (same-instance report shares,
  ...
  clause — *optional contained or cluster-local sandboxes for code that earns
  the privilege* — is deliberately **deferred**, not forgotten: Borealis has
