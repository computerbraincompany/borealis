...
| Cloud | Profile | File |
|---|---|---|
| GCP | Proof of concept | `north_gcp_poc.png` |
| GCP | Pilot | `north_gcp_pilot.png` |
| GCP | Production | `north_gcp_prod.png` |
| AWS | Proof of concept | `north_aws_poc.png` |
| AWS | Pilot | `north_aws_pilot.png` |
| AWS | Production option 1 | `north_aws_prod_1.png` |
| AWS | Production option 2 | `north_aws_prod_2.png` |
| Azure | Proof of concept | `north_azure_poc.png` |
| Azure | Pilot | `north_azure_pilot.png` |
| Azure | Production | `north_azure_prod.png` |
| OCI | Production | `north_oci_prod.png` |
